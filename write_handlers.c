...
/************************* WRITE HANDLE *************************/
/**
 * handle_write_char - Writing a fxn that prints a string
 * @c: char types.
...
/************************* WRITE NUMBER *************************/
/**
 * write_number - Writing a fxn that prints a string
...
/**
 * write_num - Writing a fxn that write a number using a bufffer
...
/**
 * write_unsgnd - Writing a fxn that writes an unsigned number
...
/**
 * write_pointer - Writing a fxn that write a memory address
